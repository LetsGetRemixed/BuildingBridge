            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@buildingbridge.org" className="text-white hover:opacity-80 transition-opacity text-sm">
                    info@buildingbridge.org
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+1234567890" className="text-white hover:opacity-80 transition-opacity text-sm">
                    (123) 456-7890
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white text-sm">Community Center<br />123 Main Street<br />City, State 12345</p>
                </div>
              </li>
            </ul>
          </div>
